(function() {
  ...
  var render$2 = function() {
    ...
    }, expression: "content.name" } }), _c("k-tag", { attrs: { "data-state": _vm.state } }, [_vm._v(_vm._s(_vm.$t("form.block.inbox.show")) + " (" + _vm._s(this.stateText) + ")")])], 1)]);
  };
  ...
  __component__$2.options.__file = "site/plugins/kirby-form-blocks/src/components/blocks/Form.vue";
  ...
  __component__$1.options.__file = "site/plugins/kirby-form-blocks/src/components/fields/SelectOption.vue";
  ...
  var render = function() {
    ...
    var _h = _vm.$createElement;
    var _c = _vm._self._c || _h;
    return _c("k-view", { staticClass: "k-field-type-mail-view" }, [_c("k-items", [_vm._l(_vm.list, function(mail) {
      ...
      }, "action": _vm.action } }, [_c("k-status-icon", { attrs: { "status": mail.status, "tooltip": mail.tooltip } }), _c("header", { staticClass: "k-item-content" }, [_vm._t("default", function() {
  ...
  const __vue2_script = {
    ...
    methods: {
      findId(parent) {
        ...
        if (this.parent = (_d = (_c = (_b = (_a = parent.$parent) == null ? void 0 : _a.$options) == null ? void 0 : _b.propsData) == null ? void 0 : _c.id) != null ? _d : false) {
  ...
  __component__.options.__file = "site/plugins/kirby-form-blocks/src/components/fields/MailView.vue";
